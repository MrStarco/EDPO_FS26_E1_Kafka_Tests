...
echo "Creating topic $TOPIC_NAME with 4 partitions..."
docker exec docker-kafka1-1 kafka-topics --create --topic $TOPIC_NAME --bootstrap-server kafka1:29092 --partitions 4 --replication-factor 2

echo "Applying Config B (4 partitions)..."
# Same producer properties as A, just different topic config
